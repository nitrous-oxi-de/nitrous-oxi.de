const Github = () => {
  return (
    <a aria-label="nitrous-oxi.de github" href="https://github.com/nitrous-oxi-de" target={"_blank"}>
...
export const Footer = () => {
  ...
  return (
    <footer className="footer absolute bottom-0.5 w-full text-center">
        <div className="mb-3 text-md text-sky-500 text-center font-bold flex justify-center gap-2">
